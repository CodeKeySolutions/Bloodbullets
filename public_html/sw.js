...
const assets = [
  "https://static.bloodbullets.com/web/public/css/offline.css",
  "https://fonts.googleapis.com/css?family=Quicksand&display=swap",
  "https://static.bloodbullets.com/web/public/images/favicon/ms-icon-70x70.png"
];
...
const OFFLINE_NAME = "Bloodbullets-offline-v" + OFFLINE_VERSION;
const OFFLINE_ASSETS_VERSION = "1.0.2"; // 1.0 assets changes? Increment.
const OFFLINE_ASSETS = "Bloodbullets-offline-v " + + OFFLINE_VERSION + "-assets-v" + OFFLINE_ASSETS_VERSION;
