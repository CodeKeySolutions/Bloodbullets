...
array(
    ...
    'set_lang_br' =>
        array('route' => '/set/language/br', "controller"=>'languageSelect.php')
    ,
    ...
    */
    ...
    =>
    array(
        'route' => '/tebex/payment/completed',
        'controller' => 'tebex.completed.php'
    ),
    array(
        'route' => '/game/shoutbox/report/(\d+)',
        'controller' => 'game/shoutbox-report.php'
    ),
    array(
        'route' => '/admin/shoutbox/mute/(\d+)',
        'controller' => 'game/shoutbox-report.php'
    ),
    array(
        'route' => '/admin/shoutbox/delete/(\d+)',
        'controller' => 'game/shoutbox-report.php'
    ),
...
if(DEVELOPMENT === TRUE) $applicationRoutes['test'] = array('route' => '/game/test', 'controller' => 'game/test.php');
if(date('m-d') === '04-01') $applicationRoutes['aprilfool'] = array('route' => '/game/april-fool', 'controller' => 'game/fools.php');
// if(date('m-d') === '10-31') $applicationRoutes['halloween'] = array('route' => '/game/halloween', 'controller' => 'game/halloween.php');
