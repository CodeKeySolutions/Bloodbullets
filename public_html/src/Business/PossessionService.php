...
class PossessionService
{
    ...
    public function buyPossession($post)
    {
        ...
        else
        {
            ...
            $dezeThis = array("Gevangenis", "Loterij", "Kogelfabriek", "BB Bank", "Makelaardij", "Garage Makelaardij", "Uitrusting Winkels", "Voertuig Handelszaak", "Dobbel Tafel", "Race Track", "Roulette", "Fruitmachine", "Blackjack");
