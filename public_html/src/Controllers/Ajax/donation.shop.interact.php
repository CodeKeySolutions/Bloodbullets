...
$orCheck = false;
$orKeys = array("donator", "vip", "gold-member", "vip-family", "luckybox", "halving-times", "bribing-police", "ground", "smuggling-capacity", "new-profession", "new-name", "username-style", "style");
