...
if(!empty(RESET_DATE) && strtotime(RESET_DATE) > time())
{
    $twigVars['eventName'] = "Round ends";
    $twigVars['eventCountdown'] = countdownHmsTime("EventCountdown", strtotime(RESET_DATE) - time());
}
