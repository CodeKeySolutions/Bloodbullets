...
class GetLanguageContent
{
    ...
    public function initBaseLangs() // Base langs outgame + homepage
    {
        ...
        if($user->notIngame())
        {
            $langs = array(
                ...
                'ONLINE_MSG' => "There are currently <span class='online'><strong>{online}</strong></span> criminals online!",
                'PLAYERS_BEFORE_MSG' => "<span class='total'>{totalPlayers}</span> criminals! Tried before you",
                'REGISTER_BTN' => "Start Your Takeover →",
        ...
        if(!$user->notIngame()) // Base langs ingame
        {
            $langs = array(
                ...
                'STAKE' => "Stake",
                'PLAY' => "Play",
                'FOUND_WHORES'=> "You found {credits} whores with {action}!",
    ...
    public function donationShopLangs()
    {
        ...
        $langs = array(
            ...
            "BOUGHT_STYLE_ALREADY_OWNED" => "You already own this style.",
            "NEW_USERSTYLE" => "New userstyle",
