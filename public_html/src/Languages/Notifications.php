...
class Notifications
{
    ...
    public $notes = array(
        'EN' => array(
            ...
            /* FAMILY DISBAND*/
            "FAMILY_DISBAND" => "Since their was no replacement, the family {family} has been disbanded.",
            "FAMILY_PROMMOTION"=>"The boss is dead, you are now the new boss of the family {family}.",
            /* PUBLIC MISSION */
        ...
        'NL' => array(
            ...
            /* FAMILY DISBAND*/
            "FAMILY_DISBAND" => "Omdat er geen vervanging was, is de family {family} opgeheven.",
            "FAMILY_PROMMOTION" => "De baas is dood, jij bent nu de nieuwe baas van de familie {family}.",
            /* PUBLIC MISSION */
