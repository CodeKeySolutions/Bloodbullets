...
class GetLanguageContent
{
    ...
    public function initBaseLangs() // Base langs outgame + homepage
    {
        ...
        if($user->notIngame())
        {
            $langs = array(
                ...
                'ONLINE_MSG' => "Er zijn momenteel <span class='online'><strong>{online}</strong></span> criminelen online!",
                'PLAYERS_BEFORE_MSG' => "<span class='total'>{totalPlayers}</span> Criminelen gingen je voor",
                'REGISTER_BTN' => "Begin nu met overnemen →",
    ...
    public function donationShopLangs()
    {
        ...
        $langs = array(
            ...
            "BOUGHT_STYLE_ALREADY_OWNED" => "Je hebt deze stijl al in je bezit.",
            "NEW_USERSTYLE" => "Nieuwe gebruikersstijl",
            "SELECT_STYLE" => "Selecteer een stijl",
    ...
    public function garageLangs() //Garage & Fam garage langs
    {
        ...
        $langs = array(
            ...
            'GARAGE_SOLD_IN_STATE' => "Je hebt je garage verkocht in de staat {state}!",
            ...
            'FAMILY_GARAGE_SOLD' => "Je hebt je familie garage verkocht, je familie leden kunnen nu geen familie misdaden meer plegen!",
            ...
            'SELL_OR_MOVE_VEHICLES_FIRST' => "Verkoop of verplaats eerst al uw voertuigen voor je deze garage verkoopt!",
            'ADD_TO_SELL_OR_MOVE_VEHICLES_FIRST' => "<strong>Let op!</strong> Het is niet mogelijk om voertuigen van of naar het Hawa&iuml;aanse continent te verplaatsen (Reizen).",
            'SELL_OR_CRUSH_VEHICLES_FIRST' => "Verkoop of crush & convert eerst al uw voertuigen voor je deze familie garage verkoopt!",
            'REPAIR' => "Repareren",
